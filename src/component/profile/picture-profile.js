...
export default class PictureProfile extends React.Component {
  ...
  onChange = e => {
    ...
    axios.post('http://localhost:8080/v1/upload', formData, config)
        .then((res)=> { 
  ...
  render() {
    ...
    return (
      <ProfilePictureContainer>
          <img
            src={this.props.profile ? this.props.profile : "https://api.adorable.io/avatars/285/abott@adorable.png"}
            alt=""
        ...
        <div onClick={this._handleClick.bind(this)}>
          ...
          />
          {
            !this.state.isLoading ? <p>Click to update picture profile</p>
